...
<li class="nav-item">
  <a class="nav-link text-white" href="{{ route('admin.evenements.index') }}">
...
<li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.transports.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.hebergements.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.activities.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.ratings.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('admin.equipements.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                        <span class="nav-link-text ms-1">Equipement</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link text-white" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-rtl" aria-expanded="false" aria-controls="submenu-rtl">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Submenu -->
                <ul class="collapse list-unstyled" id="submenu-rtl">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="../../guide">
                            <span class="ms-1">List of guides</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="../../guide/create">

                            <span class="ms-1">add Guides</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-conseil" aria-expanded="false" aria-controls="submenu-conseil">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">public</i>
                    </div>
                    <span class="nav-link-text ms-1">Conseil Management</span>
                </a>

                <!-- Submenu -->
                <ul class="collapse list-unstyled" id="submenu-conseil">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="../../conseil">
                            <span class="ms-1">List of Conseils</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="../../conseil/create">
                            <span class="ms-1">Add Conseils</span>
                        </a>
                    </li>
                </ul>
            </li>
